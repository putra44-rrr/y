<? php
	...
	termasuk  "function.php" ;
	 ...
	 perubahan fungsi () {
	        ...
	        gema  "\ n" . warna ( "nevy" , "?] KAMU KANG OPIK YA ?: y / n" );
	        $ pilihan = trim ( fgets ( STDIN ));
	        if ( $ pilihan == "y" || $ pilihan == "Y" ) {
	         warna gema ( "merah" , "=========== (REDEEM VOUCHER) ===========" );
	        gema  "\ n" . warna ( "kuning" , "!] KALEM DONG" );
	        gema  "\ n" . warna ( "kuning" , "!] Harap tunggu" );
	        untuk ( $ a = 1 ; $ a <= 3 ; $ a ++) {
	         warna gema ( "kuning" , "." );
	        tidur ( 3 );
	        }
	        $ code1 = permintaan ( '/ promosi-pergi / v1 / promosi / pendaftaran' , $ token , '{"promo_code": "KIRIMGOSEND10"}' );
	        ...
	        gofood:
	        gema  "\ n" . warna ( "kuning" , "!] AYO KITA OPIK LAGI" );
	        gema  "\ n" . warna ( "kuning" , "!] Harap tunggu" );
	        untuk ( $ a = 1 ; $ a <= 3 ; $ a ++) {
	         warna gema ( "kuning" , "." );
	        tidur ( 3 );
	        }
	        $ code1 = permintaan ( '/ promosi-pergi / v1 / promosi / pendaftaran' , $ token , '{"promo_code": "COBAGOFOOD010420B"}' );
	        $ message = fetch_value ( $ code1 , '"message": "' , '"' );
	        if ( strpos ( $ code1 , 'Promo kamu sudah bisa dipakai' )) {
	        gema  "\ n" . color ( "green" , "+] Pesan:" . $ message );
	        tidur ( 1 );
	        ...
	        $ expired6 = getStr1 ( '"expiry_date": "' , '"' , $ cekvoucher , '6' );
	         ...
	         // if ($ pilih1 == "y" && strpos ($ no, "628")) {
	          warna gema ( "merah" , "======== (PIN ANDA = 225588) ========" ). "\ n" ;
	         $ data2 = '{"pin": "225588"}' ;
